...
describe DeliveriesController do
  ...
  #       post :create, {:delivery => { "message" => "invalid value" }}, valid_session
  #       assigns(:delivery).should be_a_new(Delivery)
  #     end
  ...
  #       Delivery.any_instance.should_receive(:update).with({ "message" => "" })
  #       put :update, {:id => delivery.to_param, :delivery => { "message" => "" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Delivery.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => delivery.to_param, :delivery => { "message" => "invalid value" }}, valid_session
  #       assigns(:delivery).should eq(delivery)
  #     end
