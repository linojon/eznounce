...
describe MembershipsController do
  ...
  # let(:valid_attributes) { { "person" => Person.create } }
  ...
  #       post :create, {:membership => { "person" => "invalid value" }}, valid_session
  #       assigns(:membership).should be_a_new(Membership)
  #     end
  ...
  #       Membership.any_instance.should_receive(:update).with({ "person" => "" })
  #       put :update, {:id => membership.to_param, :membership => { "person" => "" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Membership.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => membership.to_param, :membership => { "person" => "invalid value" }}, valid_session
  #       assigns(:membership).should eq(membership)
  #     end
